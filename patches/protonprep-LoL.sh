...
#    patch -Np1 < ../patches/winevulkan/1.3-add-support-win32-long-types.patch
    ...
    echo "LoL fixes"
    patch -Np1 < ../patches/wine-hotfixes/LoL/LoL-revert-commits-that-cause-LoL-client-post-match-hang-7.6+.patch
...
#    # hotfix 7.5 winealsa compile breakage
#    patch -Np1 < ../patches/wine-hotfixes/pending/7.5-winealsa-hotfix.patch

...
### (2-1) PROBLEMATIC COMMIT REVERT SECTION ###
    ...
    # mono
    git revert --no-commit 987acfb734bff4dade8bf556fd5e838466359c69
    git revert --no-commit 05e39c9f72a2c7734897806f63c45285c2938e68
    git revert --no-commit 147164fc7738bda2e50421d731e15489188916e1
    git revert --no-commit 147164fc7738bda2e50421d731e15489188916e1
